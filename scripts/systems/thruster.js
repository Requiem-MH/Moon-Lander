MyGame.systems.Thruster = function(spec) {
    'use strict';
    let nextName = 1;
    let particles = {};
    ...
    function create() {
        ...
        let p = {
                ...
                size: { x: size, y: size},
                direction: Random.nextAngleVector(spec.angle),
    ...
    //Function used to set spawn point of particles
    function setPosition(x, y) {
        spec.center.x = x;
        spec.center.y = y;
    }

    //Function used to set angle of particles
